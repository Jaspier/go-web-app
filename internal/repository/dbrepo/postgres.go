...
func (m *postgresDBRepo) InsertReservation(res models.Reservation) (int, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 3*time.Second) // If you can't insert res in 3s then stop. Something is wrong
	defer cancel()
	...
	stmt := `insert into reservations (first_name, last_name, email, phone, start_date, end_date, 
				...
				values ($1, $2, $3, $4, $5, $6, $7, $8, $9) returning id` // 'returning' is postgres for lastInsertID like in mySQL/mariaDB
...
func (m *postgresDBRepo) GetRestrictionsForRoomByDate(roomID int, start, end time.Time) ([]models.RoomRestriction, error) {
	...
	query := `
		...
		and room_id = $3
`
// coalesce handles when reservation_id is null (this is a case for owner block restrictions)
// i.e. if null use 0

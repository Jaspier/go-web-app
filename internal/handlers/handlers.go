...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	reservation := models.Reservation{
		...
		EndDate:   endDate,
		RoomID:    roomID,
		Room:      room, // fixes invalid data error
	}
	...
	htmlMessage := fmt.Sprintf(`
		...
		Dear %s:, <br>
		This is to confirm your reservation from %s to %s in %s.
`, reservation.FirstName, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"), reservation.Room.RoomName)
	...
	// send notifications - now to admin
	htmlMessage = fmt.Sprintf(`
...
func (m *Repository) Paradise(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "paradise.page.gohtml", &models.TemplateData{})
}

// Suite renders the room page
func (m *Repository) Suite(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "suite.page.gohtml", &models.TemplateData{})
}
...
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	_ = m.App.Session.RenewToken(r.Context()) // RenewToken prevents session fixation attacks
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	intMap["days_in_month"] = lastOfMonth.Day() // gets the number of days in month
...
func (m *Repository) AdminProcessReservation(w http.ResponseWriter, r *http.Request) {
	...
	err := m.DB.UpdateProcessedForReservation(id, 1) // 1 = processed
	if err != nil {
		log.Println(err)
	}
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, room := range rooms {
		...
		for name, value := range currMap {
			...
			// val will only have a value if it exists in the map

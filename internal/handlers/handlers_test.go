...
var theTests = []struct {
	...
	{"paradise", "/gamers-paradise", "GET", http.StatusOK},
	{"suite", "/gamers-suite", "GET", http.StatusOK},
	{"sa", "/search-availability", "GET", http.StatusOK},
	{"contact", "/contact", "GET", http.StatusOK},
	{"non-existent", "/this/page/does/not/exist", "GET", http.StatusNotFound},
	// new routes
	...
	//	{key: "first_name", value: "Allen"},
	//	{key: "last_name", value: "Jasper"},
	//	{key: "email", value: "allen@mail.com"},
...
//	rr = httptest.NewRecorder()
//
//	handler = http.HandlerFunc(Repo.PostReservation) // don't need this line but just leaving here for readability :)
//
//	handler.ServeHTTP(rr, req)
//
//	if rr.Code != http.StatusTemporaryRedirect {
